          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 d-flex">
            <div class="">
              <li class="nav-item dropdown ms-auto">
                <a id="btn-sesion" class="nav-link dropdown-toggle " href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><?php session_start();
    ...
    <section class="row">
      <div class="col-12">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body mx-3">
                ...
                <div class="md-form mb-4">
                  ...
                  <input type="time" id="hora" name="hora" class="form-control validate required">
                </div>
        ...
        <div class="text-center">
          <a href="" class="btn btn-dark btn-rounded mb-4 fs-5 btn-reserva" data-bs-toggle="modal" data-bs-target="#modalCrearReserva">Realizar una reserva</a>
        </div>
      </div>
